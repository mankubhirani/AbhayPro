...
this._companyService._getStateApi(CompanyDetails.CountryId).subscribe(
  (res: any) => {
...
this._companyService._getCityApi(CompanyDetails.stateId).subscribe((res: any) => {
  this.ngxService.stop();
  this.cityData = res.data;
});
console.log("CompanyDetails.cityId",CompanyDetails.cityId,"CompanyDetails.stateId",CompanyDetails.stateId);

this.city_id=CompanyDetails.cityId;
// this.changeCity(CompanyDetails.cityId);

this.companyForm.patchValue({
  'company_name': CompanyDetails.companyName,
  'company_email': CompanyDetails.companyEmail,
  'company_website': CompanyDetails.companyURL,
  'phoneNumber': CompanyDetails.Phone_Number,
  'idindustry_typ_id': CompanyDetails.industrytypeId,
  'employee_count_id': CompanyDetails.employeeCount,
  'city_id': CompanyDetails.cityId,
  'region': CompanyDetails.region,
  'pin_code': CompanyDetails.pinCode,
  'street_address': CompanyDetails.streetAddress,
  'timeZone': CompanyDetails.timeZone,
  'adddress': CompanyDetails.adddress,
  'remark': CompanyDetails.remark,
  'companyLocation': CompanyDetails.companyLocation,
  'tax_type_id' :  CompanyDetails.taxId,
  'state_id':CompanyDetails.stateId,
  'country_id':CompanyDetails.CountryId,
'company_logo':CompanyDetails.companyLogo,
'tax_information':CompanyDetails.taxInfo
  ...
  addCompany() {
    ...
    formData.append('contact', this.companyForm.value.country_code  +  this.companyForm.value.phoneNumber);
    ...
    formData.append('taxTypId',this.companyForm.value.tax_type_id);
    ...
    formData.append('pinCode', this.companyForm.value.pin_code);
